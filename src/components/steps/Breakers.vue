...
<template>
    ...
    <div class="p-6 mx-auto">
                ...
                <table class="w-full min-w-[700px] border-collapse text-sm sm:text-base">
                    ...
                    <thead>
                        ...
                        <tr class="border-b text-left text-gray-500">
                            ...
                            <th class="py-3 px-2 whitespace-nowrap">
                                Breaker
                            </th>
        ...
        <div class="hidden md:block pt-2">
            <div class="bg-blue-100 text-blue-700 p-2 rounded-xl text-sm font-semibold flex items-center gap-2">
        ...
        <div class="pt-2 md:hidden block">
            <div class=" bg-blue-100 text-blue-700 p-3 rounded-xl text-sm font-semibol flex flex-col gap-3">
                <!-- HEADER -->
                <div class="flex items-center gap-2">

                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="rgba(70,146,221,1)" class="flex-shrink-0">
                ...
                <div class="leading-relaxed break-words">
                    ...
                    <div>
                        AC Breaker = Inverter Rating ÷ {{ acVoltage || '-' }}V
                    </div>
                    ...
                    <div class="flex items-center gap-2 text-blue-800">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="16" fill="rgb(29, 78, 216)">
        ...
        <!-- WARNING -->
        <div class="hidden md:block pt-2">
            <div class="bg-orange-100 text-orange-700 p-2 rounded-xl text-sm font-semibold flex items-center gap-2">
        ...
        <!-- WARNING PHONE -->
        <div class="pt-2 md:hidden block">
            <div class=" bg-orange-100 text-orange-700 p-3 rounded-xl text-sm font-semibold flex flex-col gap-3">

                <div class="flex items-center gap-2">
                    
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="rgba(234,113,46,1)" class="flex-shrink-0">
                        <path d="M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM11 15V17H13V15H11ZM11 7V13H13V7H11Z"></path>
                    </svg>
        ...
        <div class="py-6">
            ...
            <h3 class="text-lg font-bold mb-6 flex items-center gap-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="36" height="36" fill="rgba(70,146,221,1)" class="shrink-0">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="border rounded-xl p-4 overflow-hidden">
                    ...
                    <h4 class="font-bold mb-4 flex items-start gap-2">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="rgba(240,187,64,1)" class="shrink-0">
                ...
                <div class="border rounded-xl p-4 overflow-hidden">
                    ...
                    <h4 class="font-bold mb-4 flex items-start gap-2">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="rgba(234,113,46,1)" class="shrink-0">
                ...
                <div class="border rounded-xl p-4 overflow-hidden">
                    ...
                    <h4 class="font-bold mb-4 flex items-start gap-2">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="rgba(70,146,221,1)" class="shrink-0">
                    ...
                    <div class="space-y-2 text-sm">
                        ...
                        <div class="flex justify-between gap-4">
                            <span class="shrink-0">Purpose</span>
                            <span class="text-right break-words">
                                Auto switch between solar & grid/genset
                            </span>
                        </div>
                ...
                <div class="border rounded-xl p-4 overflow-hidden">
                    ...
                    <div class="space-y-2 text-sm">
                        ...
                        <div class="flex justify-between gap-4">
                            <span class="shrink-0">Purpose</span>
                            <span class="text-right break-words">
                                Safe manual disconnect for maintenance
                            </span>
                        </div>
        ...
        <div class="hidden bg-blue-100 text-blue-700 p-2 rounded-xl text-sm font-semibold md:flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="rgba(70,146,221,1)"><path d="M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM11 15V17H13V15H11ZM11 7V13H13V7H11Z"></path></svg>
        ...
        <div class="md:hidden bg-blue-100 text-blue-700 p-3 rounded-xl text-sm font-semibold flex flex-col gap-3">
            <div class="flex items-center gap-2">
            ...
            <div class="leading-relaxed break-words">
                These components are highly recommended for safety
                and code compliance, even if not strictly required
